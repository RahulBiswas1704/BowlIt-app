             ...
             <div className="bg-white rounded-3xl p-8 shadow-sm border border-gray-100">
                ...
                <div className="relative">
                   <input 
                     ...
                     className="w-full p-4 bg-gray-50 border-transparent rounded-xl font-bold text-gray-900 focus:bg-white focus:ring-2 focus:ring-orange-500 outline-none transition-all"
                     value={customAmount}
