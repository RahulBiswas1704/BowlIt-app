    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 px-6 lg:px-8 font-sans">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md text-center mb-10">
        <a href="/" className="inline-block hover:scale-105 transition-transform">
          <img src="/logo.svg" alt="BowlIt Logo" className="h-16 w-auto mx-auto" />
        </a>
      </div>
              ...
              <motion.form key="step1" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="space-y-5" onSubmit={handleSendOtp}>
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input name="fullName" type="text" required placeholder="Your Name" className="block w-full pl-10 px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-orange-500 outline-none transition-all" onChange={handleChange} value={formData.fullName} />
                  </div>
                </div>
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input name="phone" type="tel" required placeholder="98765 43210" className="block w-full pl-10 px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-orange-500 outline-none transition-all" onChange={handleChange} value={formData.phone} />
                  </div>
                </div>
                <div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    {[
                      { id: 'Veg', icon: Leaf, color: 'green' },
                      { id: 'Non-Veg', icon: Beef, color: 'red' },
                      { id: 'Flexi', icon: Utensils, color: 'orange' }
                    ].map((d) => (
              ...
              <motion.form key="step2" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="space-y-6" onSubmit={handleVerifyOtp}>
                ...
                <div className="relative">
                  ...
                  <input 
                    ...
                    className="block w-full py-4 border border-gray-300 rounded-xl focus:ring-2 focus:ring-orange-500 text-center text-3xl font-bold outline-none tracking-[0.5em] transition-all" 
